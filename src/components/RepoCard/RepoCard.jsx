		...
		>
			<div className="basis-3/4 flex flex-col items-start justify-center">
				...
				<div className="flex flex-row items-center justify-center">
					<span className="text-blue-600 font-semibold mr-2 text-lg hover:underline cursor-pointer">
						<a href={repo?.url || "#"}>{repo?.name || ""}</a>
					</span>
					<span className="border border-gray-300 px-2  rounded-xl text-xs text-gray-600 capitalize">
						{repo?.visibility || ""}
					</span>
				</div>
				...
				<div className="flex flex-row items-center justify-center my-3 cursor-pointer">
					<span className="mr-1 flex items-center justify-center font-semibold px-2 py-1 bg-blue-100 text-blue-600 hover:bg-blue-600 hover:text-white rounded-xl text-xs">
						personal-website
					</span>
					<span className="mr-1 flex items-center justify-center font-semibold px-2 py-1 bg-blue-100 text-blue-600 hover:bg-blue-600 hover:text-white rounded-xl text-xs">
						portfolio
				...
				<div className="flex flex-row items-center justify-center">
					...
					<span className="mx-3 flex flex-row items-center justify-center text-gray-600 text-xs">
						...
						<a href={repo?.stargazers_url || "#"} target="_blank">
							<p className="mx-1">{repo?.stargazers_count || 0}</p>
						</a>
					</span>
					...
					<a
						href="/"
						className="mx-1.5 flex flex-row items-center justify-center text-gray-600 text-xs hover:text-blue-500 cursor-pointer"
					>
						<svg
							aria-label="fork"
							role="img"
						...
						<p className="mx-1">{repo?.forks_count || 0}</p>
					</a>
					{/* licence */}
					<span className="mx-3 flex flex-row items-center justify-center text-gray-600 text-xs">
						<svg
						...
						<p className="mx-1">{repo?.license || "MIT License"}</p>
					</span>

					{/* updated */}
					<p className="mx-3 text-gray-600 text-xs">
						Updated{" "}
						{formatDistance(new Date(repo?.updated_at || new Date()), new Date())} ago
					</p>
				</div>
			</div>
			...
			<div className="basis-1/4 flex flex-col items-end justify-between">
				<button className="px-2 mb-8 py-1 flex flex-row items-center text-sm font-semibold text-gray-800 justify-between border bg-gray-100 rounded focus:bg-gray-200 focus:outline-none">
					...
					<MdOutlineArrowDropDown className="text-lg ml-1 text-gray-600 border-l-2 " />
				</button>
				<div className="">
